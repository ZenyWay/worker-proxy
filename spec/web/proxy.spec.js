...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var utils_1=require("../common/utils"),debug=require("debug"),log=debug("index-generator"),IndexGeneratorClass=function(){function e(e){this.index=e}return e.newInstance=function(n){return new e(Number.isSafeInteger(n)?n:0)},e.isIndexGenerator=function(e){return utils_1.isObject(e)&&utils_1.isFunction(e.next)&&utils_1.isNumber(e.next())},e.prototype.next=function(){return Number.isSafeInteger(++this.index)?this.index:this.index=Number.MIN_SAFE_INTEGER},e.prototype.value=function(){return this.index},e}();exports.isIndexGenerator=IndexGeneratorClass.isIndexGenerator;var newIndexGenerator=IndexGeneratorClass.newInstance;exports.default=newIndexGenerator;

},{"../common/utils":7,"debug":undefined}],9:[function(require,module,exports){
"use strict";function toWorker(e,t){if(isWorker(e))return e;try{if(utils_1.isFunction(e))return(utils_1.isFunction(t)?t:require("webworkify"))(e);if(utils_1.isString(e))return new Worker(e)}catch(e){}throw new TypeError("invalid argument")}function getObjectUrl(e){return e.objectURL}function isWorker(e){return utils_1.isObject(e)&&utils_1.isFunction(e.postMessage)&&utils_1.isFunction(e.terminate)}Object.defineProperty(exports,"__esModule",{value:!0});var tslib_1=require("tslib"),indexed_queue_1=require("./indexed-queue"),utils_1=require("../common/utils"),Promise=require("bluebird"),debug=require("debug"),log=debug("worker-proxy"),ServiceProxyClass=function(){function e(e){this.worker=e.worker,this.hasObjectUrl=utils_1.isString(getObjectUrl(this.worker)),this.revokeObjectURL=e.revokeObjectURL,this.worker.onmessage=this.onmessage.bind(this),this.calls=e.queue,this.timeout=e.timeout,this.service=this.call({method:"getServiceMethods"}).call("reduce",this.proxyServiceMethod.bind(this),{})}return e.newInstance=function(t,r){var i={};i.timeout=r&&utils_1.isNumber(r.timeout)?r.timeout:e.timeout,i.worker=toWorker(t,r&&r.workify),i.queue=r&&indexed_queue_1.isIndexedQueue(r.queue)?r.queue:indexed_queue_1.default(),i.revokeObjectURL=r&&r.revokeObjectURL||URL.revokeObjectURL.bind(URL);var o=new e(i);return log("ServiceProxyClass.newInstance",o),{service:o.service,kill:o.kill.bind(o),terminate:o.terminate.bind(o)}},e.prototype.kill=function(){this.worker.terminate()},e.prototype.terminate=function(){var e=this;return this.call({method:"onterminate"}).then(function(){return e.kill()})},e.prototype.onmessage=function(e){if(this.hasObjectUrl&&this.revokeObjectUrl(),this.calls.has(e.data.uuid)){var t=this.calls.pop(e.data.uuid);if(utils_1.isObject(t)&&utils_1.isFunction(t[e.data.method])){log("WorkerService.onmessage target method",e.data.method);var r=utils_1.isArrayLike(e.data.args)?e.data.args:[];t[e.data.method].apply(void 0,r)}}},e.prototype.call=function(e){var t=this;log("ServiceProxy.call",e);var r=tslib_1.__assign({},e),i=new Promise(function(e,i){r.uuid=t.calls.push({resolve:e,reject:i})}).timeout(this.timeout).catch(Promise.TimeoutError,function(e){return log("ServiceProxy.call uuid =",r.uuid,e),t.calls.has(r.uuid)&&t.calls.pop(r.uuid),Promise.reject(e)});return setTimeout(this.worker.postMessage.bind(this.worker,r)),i},e.prototype.proxyServiceMethod=function(e,t){return e[t]=function(){return this.call({target:"service",method:t,args:Array.prototype.slice.call(arguments)})}.bind(this),e},e.prototype.revokeObjectUrl=function(){this.hasObjectUrl=!1,this.revokeObjectURL(getObjectUrl(this.worker))},e}();ServiceProxyClass.timeout=18e4;var newServiceProxy=ServiceProxyClass.newInstance;exports.default=newServiceProxy;
